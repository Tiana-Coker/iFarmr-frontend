...
export default function Hero() {
  return (
    <div className="flex justify-center min-h-[100vh]" 
     style={{ backgroundImage: `url(${IMAGES.HERO_BG})`, backgroundRepeat:"no-repeat", backgroundSize:"cover", backgroundBlendMode:'overlay', backgroundColor:"rgba(30, 30, 30, 0.7)" }}>
        <div className='flex flex-col items-center justify-center w-[80%] text-white'>
            <div className='text-[30px] sm:text-[60px] lg:text-[90px] leading-[43.6px] sm:leading-[93.6px] text-center mb-6 font-[700]'>Empower Your Farm with Farm Extension</div>
